...
static const SDL_DialogFileFilter _sdl_filters[] = {
...
bool file_dialog_handler_open_dialog(FileDialogHandler* handler, const FileDialogHandlerOpenArgs* args) {
  ...
  SDL_SetPointerProperty(sdl_properties, SDL_PROP_FILE_DIALOG_FILTERS_POINTER, (void*) _sdl_filters);
  SDL_SetNumberProperty(sdl_properties, SDL_PROP_FILE_DIALOG_NFILTERS_NUMBER, sizeof(_sdl_filters) / sizeof(SDL_DialogFileFilter));
