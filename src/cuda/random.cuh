...
enum QuasiRandomTarget : uint32_t {
  ...
  QUASI_RANDOM_TARGET_BSDF_RIS_DIFFUSE         = 149,  /* 1 */
  QUASI_RANDOM_TARGET_BSDF_RIS_REFRACTION      = 150,  /* 1 */
  QUASI_RANDOM_TARGET_RIS_LIGHT_ID             = 151,  /* 32x32 */
  QUASI_RANDOM_TARGET_RIS_RESAMPLING           = 1175, /* 32x32 */
  QUASI_RANDOM_TARGET_RIS_RAY_DIR              = 2199, /* 32x32 */
  QUASI_RANDOM_TARGET_RIS_LIGHT_TREE           = 3223, /* 32 */
  QUASI_RANDOM_TARGET_CAUSTIC_INITIAL          = 3255, /* 128 */
  QUASI_RANDOM_TARGET_CAUSTIC_RESAMPLE         = 3383, /* 128 */
  QUASI_RANDOM_TARGET_CAUSTIC_SUN_DIR          = 3511, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_SUN_BSDF           = 3512, /* 2 */
  QUASI_RANDOM_TARGET_LIGHT_TOY_BSDF           = 3514, /* 2 */
  QUASI_RANDOM_TARGET_LIGHT_BSDF               = 3516, /* 2x32 */
  QUASI_RANDOM_TARGET_LIGHT_SUN_RAY            = 3580, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_SUN_RIS_RESAMPLING = 3581, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_TOY_RAY            = 3582, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_TOY_RIS_RESAMPLING = 3583, /* 1 */
