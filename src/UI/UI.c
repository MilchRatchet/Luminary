...
static UITab create_general_renderer_panels(UI* ui, RaytraceInstance* instance) {
  ...
  panels[i++] = create_slider(ui, "RIS Candidates Count", &(instance->ris_settings.initial_reservoir_size), 0, 0.02f, 0.0f, 32.0f, 0, 1);
  panels[i++] =
...
static UITab create_camera_post_panels(UI* ui, RaytraceInstance* instance) {
  ...
  panels[i++] = create_slider(ui, "Film Grain", &(instance->scene.camera.film_grain), 0, 0.0001f, 0.0f, 1.0f, 0, 0);
