...
enum QuasiRandomTargetAllocation : uint32_t {
  ...
  QUASI_RANDOM_TARGET_ALLOCATION_LIGHT_TOY_BSDF           = 2,
  ...
  QUASI_RANDOM_TARGET_ALLOCATION_LIGHT_TOY_RAY            = 1,
  QUASI_RANDOM_TARGET_ALLOCATION_LIGHT_TOY_RIS_RESAMPLING = 1,
  QUASI_RANDOM_TARGET_ALLOCATION_BRIDGE_LIGHT_TREE        = 1,
  QUASI_RANDOM_TARGET_ALLOCATION_BRIDGE_LIGHT_LIST        = 1,
  QUASI_RANDOM_TARGET_ALLOCATION_BRIDGE_LIGHT_POINT       = 1,
  QUASI_RANDOM_TARGET_ALLOCATION_BRIDGE_DISTANCE          = (32 * 32),
  QUASI_RANDOM_TARGET_ALLOCATION_BRIDGE_PHASE             = (32 * 32),
  QUASI_RANDOM_TARGET_ALLOCATION_BRIDGE_PHASE_METHOD      = (32 * 32)
...
enum QuasiRandomTarget : uint32_t {
  ...
  QUASI_RANDOM_TARGET_LIGHT_TOY_BSDF           = QUASI_RANDOM_TARGET_ALLOC(LIGHT_SUN_BSDF),
  QUASI_RANDOM_TARGET_LIGHT_BSDF               = QUASI_RANDOM_TARGET_ALLOC(LIGHT_TOY_BSDF),
  ...
  QUASI_RANDOM_TARGET_LIGHT_TOY_RAY            = QUASI_RANDOM_TARGET_ALLOC(LIGHT_SUN_RIS_RESAMPLING),
  QUASI_RANDOM_TARGET_LIGHT_TOY_RIS_RESAMPLING = QUASI_RANDOM_TARGET_ALLOC(LIGHT_TOY_RAY),
  QUASI_RANDOM_TARGET_BRIDGE_LIGHT_TREE        = QUASI_RANDOM_TARGET_ALLOC(LIGHT_TOY_RIS_RESAMPLING),
  ...
  QUASI_RANDOM_TARGET_BRIDGE_PHASE_METHOD      = QUASI_RANDOM_TARGET_ALLOC(BRIDGE_PHASE),

  QUASI_RANDOM_TARGET_COUNT = QUASI_RANDOM_TARGET_ALLOC(BRIDGE_PHASE_METHOD)
