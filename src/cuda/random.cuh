...
enum QuasiRandomTarget : uint32_t {
  ...
  QUASI_RANDOM_TARGET_CAUSTIC_INITIAL          = 3223, /* 32 */
  QUASI_RANDOM_TARGET_CAUSTIC_RESAMPLE         = 3255, /* 32 */
  QUASI_RANDOM_TARGET_CAUSTIC_SUN_DIR          = 3287, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_SUN_BSDF           = 3288, /* 2 */
  QUASI_RANDOM_TARGET_LIGHT_TOY_BSDF           = 3290, /* 2 */
  QUASI_RANDOM_TARGET_LIGHT_BSDF               = 3292, /* 2 * 32 */
  QUASI_RANDOM_TARGET_LIGHT_SUN_RAY            = 3356, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_SUN_RIS_RESAMPLING = 3357, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_TOY_RAY            = 3358, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_TOY_RIS_RESAMPLING = 3359, /* 1 */
