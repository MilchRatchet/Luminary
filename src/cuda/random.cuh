...
enum QuasiRandomTarget : uint32_t {
  ...
  QUASI_RANDOM_TARGET_LIGHT_BSDF               = 3292, /* 2 */
  QUASI_RANDOM_TARGET_LIGHT_SUN_RAY            = 3294, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_SUN_RIS_RESAMPLING = 3295, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_TOY_RAY            = 3296, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_TOY_RIS_RESAMPLING = 3297, /* 1 */
