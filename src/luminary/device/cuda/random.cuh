...
enum QuasiRandomTargetAllocation : uint32_t {
  ...
  QUASI_RANDOM_TARGET_ALLOCATION_VOLUME_DIST              = 32,
  QUASI_RANDOM_TARGET_ALLOCATION_VOLUME_RIS               = 1,
  QUASI_RANDOM_TARGET_ALLOCATION_VOLUME_STRATEGY          = 1,
...
enum QuasiRandomTarget : uint32_t {
  ...
  QUASI_RANDOM_TARGET_VOLUME_RIS               = QUASI_RANDOM_TARGET_ALLOC(VOLUME_DIST),
  QUASI_RANDOM_TARGET_VOLUME_STRATEGY          = QUASI_RANDOM_TARGET_ALLOC(VOLUME_RIS),
  QUASI_RANDOM_TARGET_RUSSIAN_ROULETTE         = QUASI_RANDOM_TARGET_ALLOC(VOLUME_STRATEGY),
