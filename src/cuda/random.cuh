...
enum QuasiRandomTargetAllocation : uint32_t {
  ...
  QUASI_RANDOM_TARGET_ALLOCATION_CAUSTIC_RESAMPLE         = 128,
...
enum QuasiRandomTarget : uint32_t {
  ...
  QUASI_RANDOM_TARGET_BOUNCE_TRANSPARENCY      = QUASI_RANDOM_TARGET_ALLOC(BOUNCE_DIR),
  QUASI_RANDOM_TARGET_LIGHT_TRANSPARENCY       = QUASI_RANDOM_TARGET_ALLOC(BOUNCE_TRANSPARENCY),
  QUASI_RANDOM_TARGET_LENS                     = QUASI_RANDOM_TARGET_ALLOC(LIGHT_TRANSPARENCY),
  ...
  QUASI_RANDOM_TARGET_COUNT = QUASI_RANDOM_TARGET_ALLOC(LIGHT_TOY_RIS_RESAMPLING)
