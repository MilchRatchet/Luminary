...
enum DeviceRendererQueueActionType {
  ...
  DEVICE_RENDERER_QUEUE_ACTION_TYPE_UPDATE_DEPTH      = 3,
  DEVICE_RENDERER_QUEUE_ACTION_TYPE_QUEUE_NEXT_SAMPLE = 4,
  DEVICE_RENDERER_QUEUE_ACTION_TYPE_END_OF_SAMPLE     = 5
