...
LUMINARY_API enum LuminaryLensTemplate {
  ...
  LUMINARY_LENS_TEMPLATE_PHYSICAL_C,  // Nikon 20mm f/8
  LUMINARY_LENS_TEMPLATE_PHYSICAL_D,  // Nikon 120mm f/4.59
  LUMINARY_LENS_TEMPLATE_PHYSICAL_E,  // Kapella 100mm f/1.0
  LUMINARY_LENS_TEMPLATE_PHYSICAL_F,  // Leica 800mm f/5.9
  LUMINARY_LENS_TEMPLATE_PHYSICAL_G,  // Zeiss Biotar 50mm f/1.4
  LUMINARY_LENS_TEMPLATE_PHYSICAL_H,  // Zeiss Sonnar 50mm f/1.5
  LUMINARY_LENS_TEMPLATE_PHYSICAL_I,  // Zeiss Planar 50mm f/1.4
  LUMINARY_LENS_TEMPLATE_PHYSICAL_J,  // Zeiss Pancolar 50mm f/2.0
  LUMINARY_LENS_TEMPLATE_PHYSICAL_K,  // Zeiss Biogon 35mm f/2.8
