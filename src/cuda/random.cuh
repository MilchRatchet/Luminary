...
enum QuasiRandomTarget : uint32_t {
  ...
  QUASI_RANDOM_TARGET_CAUSTIC_SUN_DIR          = 3289, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_SUN_BSDF           = 3290, /* 2 */
  QUASI_RANDOM_TARGET_LIGHT_TOY_BSDF           = 3292, /* 2 */
  QUASI_RANDOM_TARGET_LIGHT_BSDF               = 3294, /* 2 */
  QUASI_RANDOM_TARGET_LIGHT_SUN_RAY            = 3296, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_SUN_RIS_RESAMPLING = 3297, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_TOY_RAY            = 3298, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_TOY_RIS_RESAMPLING = 3299, /* 1 */
