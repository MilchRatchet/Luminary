...
const char* const luminary_strings_lens_template[LUMINARY_LENS_TEMPLATE_COUNT] = {
  ...
  [LUMINARY_LENS_TEMPLATE_PHYSICAL_F] = "Physical F", [LUMINARY_LENS_TEMPLATE_PHYSICAL_G] = "Physical G",
  [LUMINARY_LENS_TEMPLATE_PHYSICAL_H] = "Physical H", [LUMINARY_LENS_TEMPLATE_PHYSICAL_I] = "Physical I",
