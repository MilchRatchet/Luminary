...
static const char* _window_entity_properties_type_tooltip_string[WINDOW_ENTITY_PROPERTIES_TYPE_COUNT] = {
  [WINDOW_ENTITY_PROPERTIES_TYPE_SCENE] = "Scene",       [WINDOW_ENTITY_PROPERTIES_TYPE_SETTINGS] = "Renderer Settings",
  [WINDOW_ENTITY_PROPERTIES_TYPE_CAMERA] = "Camera",     [WINDOW_ENTITY_PROPERTIES_TYPE_OCEAN] = "Ocean",
  [WINDOW_ENTITY_PROPERTIES_TYPE_SKY] = "Sky",           [WINDOW_ENTITY_PROPERTIES_TYPE_CLOUD] = "Cloud",
  [WINDOW_ENTITY_PROPERTIES_TYPE_FOG] = "Fog",           [WINDOW_ENTITY_PROPERTIES_TYPE_PARTICLES] = "Particles",
  [WINDOW_ENTITY_PROPERTIES_TYPE_MATERIAL] = "Material", [WINDOW_ENTITY_PROPERTIES_TYPE_INSTANCE] = "Instance",
};

static const ElementButtonImage _window_entity_properties_type_button_images[WINDOW_ENTITY_PROPERTIES_TYPE_COUNT] = {
  [WINDOW_ENTITY_PROPERTIES_TYPE_SCENE]     = ELEMENT_BUTTON_IMAGE_SCENE,
...
static const char* _window_mouse_modes_tooltip_string[DISPLAY_MOUSE_MODE_COUNT] = {
  ...
  [DISPLAY_MOUSE_MODE_LOCK]    = "Lock Controls",
};
...
static const ElementButtonImage _window_mouse_modes_button_images[DISPLAY_MOUSE_MODE_COUNT] = {
  ...
  [DISPLAY_MOUSE_MODE_LOCK]    = ELEMENT_BUTTON_IMAGE_LOCK,
};
