...
enum QuasiRandomTarget : uint32_t {
  ...
  QUASI_RANDOM_TARGET_LIGHT_SUN_RAY         = 3225, /* 1 */
  QUASI_RANDOM_TARGET_LIGHT_TOY_RAY         = 3226, /* 1 */
  QUASI_RANDOM_TARGET_CAUSTIC_INITIAL       = 3227, /* 32 */
  QUASI_RANDOM_TARGET_CAUSTIC_SUN_RAY       = 3259, /* 1 */
