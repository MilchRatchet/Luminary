...
static UIPanel* create_general_panels(UI* ui, RaytraceInstance* instance) {
  ...
  panels[i++] = create_dropdown(ui, "Shading Mode", &(instance->shading_mode), 1, 4, "Default\0Albedo\0Depth\0Normal", 8);
...
static UIPanel* create_camera_panels(UI* ui, RaytraceInstance* instance) {
  ...
  panels[i++] = create_tab(ui, &(ui->tab));
  panels[i++] = create_info(ui, "Position X", &(instance->scene_gpu.camera.pos.x), PANEL_INFO_TYPE_FP32, PANEL_INFO_DYNAMIC);
  panels[i++] = create_info(ui, "Position Y", &(instance->scene_gpu.camera.pos.y), PANEL_INFO_TYPE_FP32, PANEL_INFO_DYNAMIC);
  panels[i++] = create_info(ui, "Position Z", &(instance->scene_gpu.camera.pos.z), PANEL_INFO_TYPE_FP32, PANEL_INFO_DYNAMIC);
...
static UIPanel* create_sky_panels(UI* ui, RaytraceInstance* instance) {
  ...
  panels[i++] = create_slider(ui, "Rayleigh Falloff", &(instance->scene_gpu.sky.rayleigh_falloff), 1, 0.001f, 0.0f, FLT_MAX);
  panels[i++] = create_slider(ui, "Mie Falloff", &(instance->scene_gpu.sky.mie_falloff), 1, 0.001f, 0.0f, FLT_MAX);
  panels[i++] = create_slider(ui, "Sun Intensity", &(instance->scene_gpu.sky.sun_strength), 1, 0.001f, 0.0f, FLT_MAX);
...
static UIPanel* create_ocean_panels(UI* ui, RaytraceInstance* instance) {
  ...
  panels[i++] = create_slider(ui, "Height", &(instance->scene_gpu.ocean.height), 1, 0.005f, -FLT_MAX, FLT_MAX);
  panels[i++] = create_slider(ui, "Amplitude", &(instance->scene_gpu.ocean.amplitude), 1, 0.005f, 0.0f, FLT_MAX);
  panels[i++] = create_slider(ui, "Choppyness", &(instance->scene_gpu.ocean.choppyness), 1, 0.005f, 0.0f, FLT_MAX);
  panels[i++] = create_slider(ui, "Frequency", &(instance->scene_gpu.ocean.frequency), 1, 0.005f, 0.0f, FLT_MAX);
  ...
  panels[i++] = create_slider(ui, "Speed", &(instance->scene_gpu.ocean.speed), 1, 0.005f, 0.0f, FLT_MAX);
